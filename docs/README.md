# Thai Tax Invoice documentation
...
The app currently generates seller-issued Full Tax Invoice PDFs. It does not claim to be a Revenue Department e-Tax Invoice, and the signature/stamp uploads are visual branding only.
